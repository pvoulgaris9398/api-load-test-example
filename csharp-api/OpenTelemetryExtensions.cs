...
{
    public static WebApplicationBuilder AddAppTelemetryV1(this WebApplicationBuilder builder, string serviceName)
    {
...
builder.Services.AddOpenTelemetry()
    ...
    .WithTracing(tracing => tracing
        ...
        .AddSqlClientInstrumentation(options => 
        {
            ...
            options.Enrich = (activity, method, cmd) =>
            {
                ...
                var httpRoute = Activity.Current?.GetTagItem("http.route")?.ToString() 
                                ?? "unknown-endpoint";
    ...
    public static WebApplicationBuilder AddAppTelemetryV2(this WebApplicationBuilder builder, string serviceName)
    {
